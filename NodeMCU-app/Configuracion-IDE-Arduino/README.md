...
![file-preferences](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/file-preferences.png)
...
![preferences](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/preferences.png)

Luego se selecciona "Tools > Board: > Boards Manager..."

![tools-board](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/tools-board.png)
...
![board-manager](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/board-manager.png)

Ahora haga click sobre "Tools > Board" y veremos que aparecen las placas "ESP8266 Boards". Seleccionamos "NodeMCU 1.0"

![Board-final](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/Board-final.png)
...
Tendremos que descargarlo y descomprimirlo para luego colocarlo en la carpeta que indicaremos. Al instalar el IDE Arduino se crea automaticamente una carpeta llamada "Arduino".
Generalmente esta carpeta se encuentra en la sección "Mis Documentos" y se caracteriza por contener la carpeta "libraries".


![arduino-libraries](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/arduino-libraries.png)

Dentro de la carpeta "Arduino", antes mencionada, crearemos una carpeta llamada "tools". A su vez dentro de esta crearemos otra carpeta llamada "ESP8266FS".
Que contendra una carpeta llamada "tool". En esta última colocaremos el archivo "esp8266fs.jar".

![esp8266fs-jar](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/esp8266fs-jar.png)
...
![carpeta-proyecto](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/carpeta-proyecto.png)
...
![tools-manage](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/tools-manage.png)
...
![PubSubClient](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/PubSubClient.png)
...
Colocamos "DHT11" y seleccionamos "Install".

![Adafruit-SHT31](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/DHT11-library.png)

Además deberemos agregar la biblioteca "Adafruit Unified Sensor". Procedemos de igual forma que con la anterior biblioteca.

![Adafruit-Unified-Sensor](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/Adafruit-Unified-Sensor.png)
...
![Credentials.](https://github.com/GridTICs/MatrIoTSASE2019/blob/master/NodeMCU-app/Configuracion-IDE-Arduino/Credentials.png)

En este [archivo ](../Sketchs-Arduino/NodeMCU-DHT11-matr/credentials.h)nosotros colocaremos todas nuestras claves privadas. A modo de ejemplo decidimos colocar un archivo genérico. Usted deberá completarlo con sus propios datos.